...
export class Licenses {
    ...
    constructor() {
        ...
        (document.getElementById('Anchovy') as HTMLAnchorElement).addEventListener('click', () => {
            this.openLicense('Anchovy');
        });
        ...
        (document.getElementById('TypesXLIFF') as HTMLAnchorElement).addEventListener('click', () => {
            this.openLicense('TypesXLIFF');
        });
        (document.getElementById('TypesExcel') as HTMLAnchorElement).addEventListener('click', () => {
            this.openLicense('TypesExcel');
        });
        (document.getElementById('TypesTerms') as HTMLAnchorElement).addEventListener('click', () => {
            this.openLicense('TypesTerms');
        });
